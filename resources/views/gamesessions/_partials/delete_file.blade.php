...
<button type="button" class="btn btn-link" data-toggle="modal" data-target="#modalDeleteFile{{$file->id}}">
    <i class="fas fa-trash-alt red"></i>
</button>


<!-- Delete File Modal HTML -->
<div class="modal fade" id="modalDeleteFile{{$file->id}}" style="display: none;">
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger lined thin"  href="{{route('upload.delete_file',$file->id)}}" role="button">Supprimer</a>
            </div>
        </div>
    </div>
</div>